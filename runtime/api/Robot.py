...
def drive_distance_all(distances, motors):
  """Drives all motors in the list a set number of encoder ticks set by the distances list.
    ...
    :param ticks: A list of integers corresponding to the number of ticks to be moved. The index of the distance should match the index of the motor names.
...
def drive_distance(degrees, motor, gear_ratio):
