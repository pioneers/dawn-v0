...
def initialize_motors():
    ...
    for index in range(len(addrs)):
        ...
        name_to_grizzly[addrs[index]] = grizzly_motor
        name_to_values[addrs[index]] = 0
        name_to_ids[addrs[index]] = addrs[index]
...
def send_peripheral_data(data):
    global peripheral_data_last_sent, antilag
